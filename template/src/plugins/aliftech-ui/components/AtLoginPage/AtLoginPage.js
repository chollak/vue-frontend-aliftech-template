...
export default defineComponent({
  ...
  props: {
    ...
    phoneErrorText: { type: String, default: 'Номер телефона не может быть пустым' },
    phone: { type: String, default: '' },
    emailLabel: { type: String, default: 'Эл.почта' },
    emailErrorText: {
      type: Array,
      default: () => ['Эл.почта не может быть пустым', 'Убедитесь в правильности эл.почти'],
    },
    ...
    passwordErrorText: {
      type: Array,
      default: () => ['Пароль не может быть пустым', 'Длина пароля минимум 6 символов'],
    },
          ...
          this.withEmail
            ? h(
                ...
                h(AtInput, {
                  ...
                  error:
                    this.isSubmitted && this.v$.email.email.$invalid && !this.v$.email.required.$invalid
            ...
            : h('div', { class: 'mb-4 mt-4 w-96' }, [
                h(AtPhoneSelect, {
                  ...
                  error: this.v$.phone.$invalid && this.isSubmitted ? this.phoneErrorText : null,
          ...
          h(
            ...
            h(
              AtInput,
              {
                ...
                placeholder: '*********',
                error:
                  this.isSubmitted && this.v$.password.minLength.$invalid && !this.v$.password.required.$invalid
