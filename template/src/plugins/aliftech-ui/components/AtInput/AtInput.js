...
export default defineComponent({
  name: 'AtInput',
  emits: ['update:modelValue', 'trailingButtonClick', 'update:onFocus'].concat(InputEventsTypes),
  props: {
    ...InputElements.props,
  ...
  render() {
    ...
    const inputEl = this.mask
      ? h(
          InputMask,
          Object.assign({}, inputProps, setInputEvents(this.$emit), {
    ...
    return h('div', [
      h('div', { class: 'flex justify-between items-center' }, [
        ...
        // Hint
        this.hint ? h('span', { class: 'text-sm text-gray-500', id: `${this.id}-optional` }, this.hint) : null,
      ]),
      h(
        'div',
        {
