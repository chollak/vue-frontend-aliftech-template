  ...
  return (Array.isArray(props.head) && props.head.length) || (Array.isArray(props.elements) && props.elements.length)
    ? h(
        ...
        Object.assign({}, context.attrs, {
          class: ['at-panel-no-padding sm:rounded-lg'].concat('class' in context.attrs ? context.attrs.class : ''),
        }),
        [
          h(
            'div',
            {
              class: 'at-table-wrapper shadow border-b border-gray-200 sm:rounded-lg',
            },
            [
                        ...
                        props.elements.map((element, index) => {
                          ...
                          if (withTr) {
                            return h(
                              ...
                              {
                                class: `${
                                  props.type === 'striped' ? (index % 2 === 0 ? 'bg-white' : 'bg-gray-50') : ''
                ...
                ? h(
                    'div',
                    {
                      class: [
                        'px-4 py-5 sm:px-6',
                        {
                          'border-t border-gray-200': transformToBool(props.borderFooter),
                        },
                      ],
                    },
