import { h, defineComponent, ref, onMounted, watch, onBeforeUnmount, Transition } from 'vue';
    ...
    return h(Popover, {}, popoverProps => {
      return [
        ...
        h(
          Transition,
          {
            enterActiveClass: 'transition transition-opacity',
            enterFromClass: 'opacity-0',
            enterToClass: 'opacity-100',
            leaveActiveClass: 'transition transition-opacity',
