...
import { validateDropdownItem } from '../AtSidebar/validations';
...
export default defineComponent({
  ...
  render() {
    ...
    return !this.isMobileOrTablet
      ? h(
          Menu,
          { class: 'px-3 mt-6 relative inline-block text-left w-full', as: 'div' },
          {
            default: () => [
              h('div', [
                h(
                    ...
                    default: () =>
                      h('span', { class: ['flex w-full justify-between items-center'] }, [
                        h(
                          ...
                          [
                            h('img', {
                              class: ['w-10 h-10 bg-gray-300 rounded-full flex-shrink-0 object-cover'],
                              src:
                            ...
                            h('span', { class: ['flex-1 min-w-0 text-left'] }, [
                              h(
                                'span',
                                {
                                  class: ['text-gray-900 text-sm font-medium truncate block'],
                                },
              ...
              h(
                ...
                {
                  default: () => [
                    'userDropdownItems' in this.$slots ? this.$slots.userDropdownItems() : null,
                    renderDropdownItems(this.items),
                  ],
                }
              ),
            ],
