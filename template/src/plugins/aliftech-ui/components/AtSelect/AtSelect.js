    ...
    h(
      ...
      { as: 'div', modelValue: selectedItem.value, disabled: props.disabled },
      {
        default: () => [
          h(
            ListboxLabel,
            { class: 'block text-sm font-medium text-gray-700 leading-6 mb-1' },
            { default: () => ('label' in ctx.slots ? ctx.slot.label : props.label) }
          ),
                                  ...
                                  'li',
                                  {
                                    class: [
                                      item.value === (props.valueType ? selectedItem.value : selectedItem.value?.value)
                                        ? 'text-white bg-' + uiConfig.primaryBackgroundColor + '-600'
