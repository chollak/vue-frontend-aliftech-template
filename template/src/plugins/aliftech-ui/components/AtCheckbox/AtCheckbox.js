        ...
        h('div', { class: 'flex items-center h-5' }, [
          h('input', {
            class: [
              ...
              {
                'border-red-300 form-checkbox--error': transformToBool(props.error),
                'border-green-500 form-checkbox--success': transformToBool(props.success),
              },
            ],
            type: 'checkbox',
              ...
              { id: props.id },
              {
                default: () => [
                  ...
                  'default' in context.slots
                    ? h('span', { class: 'text-gray-500 block font-normal' }, context.slots.default())
                    : null,
                ],
              }
            )
