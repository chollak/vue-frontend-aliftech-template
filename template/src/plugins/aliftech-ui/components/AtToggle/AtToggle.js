...
const yIcon = (
  <svg class={['h-3 w-3 text-' + uiConfig.primaryTextColor + '-600']} fill='currentColor' viewBox='0 0 12 12'>
...
const AtToggle = (props, { emit }) => {
  const iconWithoutLabel = h(
    ...
    {
      class: [
        props.modelValue ? 'bg-' + uiConfig.primaryBackgroundColor + '-600' : 'bg-gray-200',
          ...
          [
            props.withIcon
              ? h(
                  ...
                  {
                    class: [
                      props.modelValue ? 'opacity-0 ease-out duration-100' : 'opacity-100 ease-in duration-200',
            ...
            props.withIcon
              ? h(
                  ...
                  {
                    class: [
                      props.modelValue ? 'opacity-100 ease-in duration-200' : 'opacity-0 ease-out duration-100',
                      'absolute inset-0 h-full w-full flex items-center justify-center transition-opacity',
                    ],
                    'aria-hidden': true,
                  },
    ...
    },
    {
      default: () => [
        ...
        h('span', { class: 'flex-grow flex flex-col' }, [
          ...
          props.description
            ? h(SwitchDescription, { as: 'span', class: 'text-sm text-gray-500' }, { default: () => props.description })
            : null,
        ]),
