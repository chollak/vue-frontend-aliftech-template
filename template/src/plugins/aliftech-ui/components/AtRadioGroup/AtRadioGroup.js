...
const AtRadioGroup = (props, { emit, slots }) => {
  return h(
    ...
    {
      default: () =>
        h('div', { class: ['bg-white rounded-md -space-y-px', { 'flex': props.inline }] }, [
                  ...
                  return h(
                    'div',
                    {
                      class: [
                        ...
                        checked
                          ? (props.noBorder ? '' : 'bg-' + uiConfig.primaryBackgroundColor + '-50 ') +
                            'border-' +
                            ...
                            item.subtitle
                              ? h(
                                  RadioGroupDescription,
                                  {
                                    as: 'span',
                                    class: [
                                      checked ? 'text-' + uiConfig.primaryTextColor + '-700' : 'text-gray-500',
                                      'block text-sm',
                                    ],
                                  },
